...
pygame.display.set_caption("snake game by Anri Tsetskhladze")
...
food_pos = {
	...
	"y": round(random.randrange(0, height - snake_size[0]) / 10) * 10,
}
  ...
  # clear screen
    ...
    # detect collision with tail
        for i,v in enumerate(snake_tails):
            ...
            and snake_pos["y"]+snake_pos["y_change"] == snake_tails[i][1]): snake_tails = snake_tails[:i]
            break
